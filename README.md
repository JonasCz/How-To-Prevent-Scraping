#A guide to preventing scraping
...
In order to hinder scraping (also known as _Screenscraping_, _web data mining_, _web harvesting_, or _web data extraction_), it helps to know how these scrapers work, and what prevents them from working well, and this is what this answer is about.
...
* HTML scrapers and parsers, such as ones based on [Jsoup](http://jsoup.org), [Scrapy](http://scrapy.org/), and many others. These work by extracting data from your pages based on patterns in your HTML, usually ignoring everything else. 
...
* **Don't just monitor & rate limit by IP address - use other indicators too:**
    ...
    * Http headers and their order, especially User-Agent.
    ...
    Related questions on Security.SE:
